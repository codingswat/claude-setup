...
support, and anything else worth noting for future sessions. Then run /init to study the
code, and draft ONE `CLAUDE.md` combining my answers with what you found. Show it to me
for review before saving. After the CLAUDE.md is approved, copy the starter files from
